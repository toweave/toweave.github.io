...
import ChoiceJavaScript from './../components/choice-javascript'
...
class JavaScriptIndex extends React.Component {
  ...
  render () {
    ...
    return (
      <LayoutBox location={this.props.location} title={siteTitle}>
        <SEO title="Toweave's JavaScript." keywords={[`Toweave`, `blog`, `gatsby`, `javascript`, `react`]}/>
        <Row>
...
export const pageQuery = graphql`
  query {
    ...
    allMarkdownRemark(
      ...
      filter: {fileAbsolutePath: {regex: "/(\\/content\\/javascript)/.*\\\\.md$/"}}
    ) {
      edges {
        node {
          excerpt
