...
import ChoiceHTMLCSS from './../components/choice-html-css'
...
class HtmlCssIndex extends React.Component {
  ...
  render () {
    ...
    return (
      <LayoutBox location={this.props.location} title={siteTitle}>
        <SEO title="Toweave's HTML CSS." keywords={[`Toweave`, `blog`, `gatsby`, `javascript`, `react`, `html`, `css`]}/>
        <Row>
...
export const pageQuery = graphql`
  query {
    ...
    allMarkdownRemark(
      ...
      filter: {fileAbsolutePath: {regex: "/(\\/content\\/htmlcss)/.*\\\\.md$/"}}
    ) {
      edges {
        node {
          excerpt
